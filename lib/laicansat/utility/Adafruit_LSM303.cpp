...
void Adafruit_LSM303::read()
{
  ...
  accelData.x = accelData.x > 2048 ? -(4096 - accelData.x) : (accelData.x);
  accelData.y = accelData.y > 2048 ? -(4096 - accelData.y) : (accelData.y);
  accelData.z = accelData.z > 2048 ? -(4096 - accelData.z) : (accelData.z);
